import { RouteTimeListRoutingModule } from './route-time-mgmt-list-routing.module';
...
@NgModule({
  ...
  declarations: [RouteTimeListComponent]
})
export class RouteTimeListModule { }
