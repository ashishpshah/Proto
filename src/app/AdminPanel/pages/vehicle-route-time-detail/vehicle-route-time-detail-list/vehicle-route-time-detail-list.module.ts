import { VehicleRouteTimeDetailListRoutingModule } from './vehicle-route-time-detail-list-routing.module';
...
@NgModule({
  imports: [
    CommonModule,
    VehicleRouteTimeDetailListRoutingModule
    ,SharedModule
    ,NgxDataTableModule
    ,TableModule,
    CalendarModule,
  ...
  declarations: [VehicleRouteTimeDetailListComponent]
})
export class VehicleRouteTimeDetailListModule { }
